...
class RectangularRoom:
    ...
    def inner(self) -> Tuple[slice, slice]:
        ...
        """
        #Remember count from 0 so +1 for area so we have at least a 1 gap between rooms
...
def tunnel_between(
    ...
    #Yield returns the values but keeps the state rather then closing it off,
    #picks up where we left off when called again
