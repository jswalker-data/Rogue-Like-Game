...
class EventDispatch(Generic[T]):
    ...
    def ev_quit(self, event: Quit) -> T | None:
        """Called when the termination of the program is requested."""

    def ev_keydown(self, event: KeyDown) -> T | None:
        """Called when a keyboard key is pressed or repeated."""

    def ev_keyup(self, event: KeyUp) -> T | None:
        """Called when a keyboard key is released."""

    def ev_mousemotion(self, event: MouseMotion) -> T | None:
        """Called when the mouse is moved."""

    def ev_mousebuttondown(self, event: MouseButtonDown) -> T | None:
        """Called when a mouse button is pressed."""

    def ev_mousebuttonup(self, event: MouseButtonUp) -> T | None:
        """Called when a mouse button is released."""

    def ev_mousewheel(self, event: MouseWheel) -> T | None:
        """Called when the mouse wheel is scrolled."""

    def ev_textinput(self, event: TextInput) -> T | None:
        """Called to handle Unicode input."""

    def ev_windowshown(self, event: WindowEvent) -> T | None:
        """Called when the window is shown."""

    def ev_windowhidden(self, event: WindowEvent) -> T | None:
        """Called when the window is hidden."""

    def ev_windowexposed(self, event: WindowEvent) -> T | None:
    ...
    def ev_windowmoved(self, event: WindowMoved) -> T | None:
        """Called when the window is moved."""

    def ev_windowresized(self, event: WindowResized) -> T | None:
        """Called when the window is resized."""

    def ev_windowsizechanged(self, event: WindowResized) -> T | None:
        """Called when the system or user changes the size of the window."""

    def ev_windowminimized(self, event: WindowEvent) -> T | None:
        """Called when the window is minimized."""

    def ev_windowmaximized(self, event: WindowEvent) -> T | None:
        """Called when the window is maximized."""

    def ev_windowrestored(self, event: WindowEvent) -> T | None:
        """Called when the window is restored."""

    def ev_windowenter(self, event: WindowEvent) -> T | None:
        """Called when the window gains mouse focus."""

    def ev_windowleave(self, event: WindowEvent) -> T | None:
        """Called when the window loses mouse focus."""

    def ev_windowfocusgained(self, event: WindowEvent) -> T | None:
        """Called when the window gains keyboard focus."""

    def ev_windowfocuslost(self, event: WindowEvent) -> T | None:
        """Called when the window loses keyboard focus."""

    def ev_windowclose(self, event: WindowEvent) -> T | None:
        """Called when the window manager requests the window to be closed."""

    def ev_windowtakefocus(self, event: WindowEvent) -> T | None:
        pass

    def ev_windowhittest(self, event: WindowEvent) -> T | None:
        pass
